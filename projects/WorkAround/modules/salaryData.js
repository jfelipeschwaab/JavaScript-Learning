// Dados de salários no formato de array
const salaryData = [
  ...
  export const getRoles = () => ['CTO', 'Technical Lead', 'Software Engineer II', 'Software Engineer I'];
  
  export const getCompanies = () => ['Big Data Inc.', 'Medium Data Inc.', 'Small Data Inc.'];
  
  export const getDataByRole = (role) => salaryData.filter(obj => obj.role === role);
  
  export const getDataByCompany = (company) => salaryData.filter(obj => obj.company === company);
